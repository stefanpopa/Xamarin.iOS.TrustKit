...
namespace Xamarin.iOS.TrustKit
{
	...
	partial interface Constants
	{
		...
		// extern const TSKDomainConfigurationKey kTSKPublicKeyAlgorithms __attribute__((deprecated("Starting with TrustKit 1.6.0, key algorithms no longer need to be specified; remove TSKPublicKeyAlgorithms from your configuration.")));
		[Field("kTSKPublicKeyAlgorithms", "__Internal")]
		NSString kTSKPublicKeyAlgorithms { get; }
		...
		// extern const TSKSupportedAlgorithm kTSKAlgorithmRsa2048 __attribute__((deprecated("Starting with TrustKit 1.6.0, key algorithms no longer need to be specified; remove TSKPublicKeyAlgorithms from your configuration.")));
		[Field("kTSKAlgorithmRsa2048", "__Internal")]
		NSString kTSKAlgorithmRsa2048 { get; }

		// extern const TSKSupportedAlgorithm kTSKAlgorithmRsa4096 __attribute__((deprecated("Starting with TrustKit 1.6.0, key algorithms no longer need to be specified; remove TSKPublicKeyAlgorithms from your configuration.")));
		[Field("kTSKAlgorithmRsa4096", "__Internal")]
		NSString kTSKAlgorithmRsa4096 { get; }

		// extern const TSKSupportedAlgorithm kTSKAlgorithmEcDsaSecp256r1 __attribute__((deprecated("Starting with TrustKit 1.6.0, key algorithms no longer need to be specified; remove TSKPublicKeyAlgorithms from your configuration.")));
		[Field("kTSKAlgorithmEcDsaSecp256r1", "__Internal")]
		NSString kTSKAlgorithmEcDsaSecp256r1 { get; }

		// extern const TSKSupportedAlgorithm kTSKAlgorithmEcDsaSecp384r1 __attribute__((deprecated("Starting with TrustKit 1.6.0, key algorithms no longer need to be specified; remove TSKPublicKeyAlgorithms from your configuration.")));
		[Field("kTSKAlgorithmEcDsaSecp384r1", "__Internal")]
		NSString kTSKAlgorithmEcDsaSecp384r1 { get; }
	}
